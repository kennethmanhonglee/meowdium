  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
    return queryInterface.bulkInsert('Pawments', [
      ...
      { userId: 6, pawstId: 7, content: 'meow meow meow', createdAt: new Date(), updatedAt: new Date() },
      ...
      { userId: 2, pawstId: 13, content: 'i only have cats in this world', createdAt: new Date(), updatedAt: new Date() },
      ...
      { userId: 3, pawstId: 9, content: 'bubba hates cats!', createdAt: new Date(), updatedAt: new Date() },
